...
class LeaveOutRequestsScreen extends StatefulWidget {
  @override
  State<LeaveOutRequestsScreen> createState() => _LeaveOutRequestsScreenState();
}

class _LeaveOutRequestsScreenState extends State<LeaveOutRequestsScreen> {
                ...
                children: [
                  ...
                  Column(
                    children: [
                      ...
                      CustomAppBarForm(text: AppText.leaveOutRequest),
                      10.height,
                      customTextFormFiald(
                          controller: typeController,
                          validate: validateType,
                          onChanged: (value) => controller.updateLeaveType(value),
                          validator: (value) {
                            setState(() {
                      ...
                      customTextFormFiald(
                          ...
                          question: true,
                          onChanged: (value) => controller.updateLeaveReason(value),
                          validator: (value) {
                            setState(() {
                      ...
                      CustomButton.buttonStyle(
                        ...
                        onPressed: () {
                          if (_formKey.currentState!.validate()) {
                            controller.submitLeaveOutRequest();
                          }
                        },
                      ),
                    ],
